...
export const WRONG_PAY_TO = "A5D55SSWZFKTMSZ2CCCOMDVM3J4ROZT2Z2KAKXM26WQEVSLVSM3ZEEPKMQ";
...
export function paymentRequired(accepts: PaymentRequirements[] = [requirement()], over: Partial<PaymentRequired> = {}): PaymentRequired {
  return {
    ...
    resource: { url: "https://alpha-hunter-x402-production.up.railway.app/v1/token/investigate", description: "", mimeType: "application/json" },
    accepts,
    extensions: { bazaar: { info: { tags: ["x402-global-challenge"] } } },
    ...over,
  } as PaymentRequired;
}
...
/** Grupo Mainnet no formato esperado: [feePayer pay, axfer do payer]. */
export function buildGroup(o: TxnOverrides = {}): { txns: algosdk.Transaction[]; encoded: Uint8Array[] } {
  const sp = o.testnet ? params(TESTNET_GENESIS_HASH, "testnet-v1.0") : params();

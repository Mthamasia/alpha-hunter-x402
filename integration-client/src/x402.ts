...
/**
 * x402Client registrado SOMENTE para Algorand Testnet, com spend controls
 * nativos da biblioteca limitando a 50000 unidades do ASA 10458941 (segunda
 ...
 */
export function createTestnetAlgorand(): AlgorandClient {
  return AlgorandClient.testNet().setDefaultValidityWindow(VALIDITY_WINDOW_ROUNDS);
}
...
export function buildPeraHttpClient(
  ...
  account: string,
  onBeforeSign?: () => void,
  algorand: AlgorandClient = createTestnetAlgorand(),
) {
